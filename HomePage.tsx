...
const UserHeaderCard = ({ navigateTo }: { navigateTo: (page: string, params?: any) => void; }) => (
    <div className="p-5 bg-white rounded-xl shadow-sm">
         <div className="flex justify-between items-center">
            ...
            <div onClick={() => navigateTo('employee-info')} className="flex items-center text-sm font-medium text-slate-600 cursor-pointer group hover:text-[#5fc38f] transition-colors">
                <span>个人资料</span>
                <ChevronRightIcon className="!w-5 !h-5 ml-1 group-hover:translate-x-0.5 transition-transform" />
            </div>
        </div>
    </div>
);
    ...
    return (
         <div className="w-full flex flex-col min-h-full bg-slate-100">
            ...
            <main className="flex-grow p-4 pb-24 space-y-4">
                <UserHeaderCard navigateTo={navigateTo} />
